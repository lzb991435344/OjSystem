...
$language_name=Array("C","C++","Pascal","Java","Ruby","Bash","Python","PHP");
//$language_name=Array("C","C++","Java");
//$language_name=Array("C","C++","Java","Python");
//$language_ext=Array( "c", "cc", "pas", "java", "rb", "sh", "py", "php","pl", "cs","m","bas","scm","c","cc","lua","js","go" );
//$language_ext=Array( "c", "cc", "java", "py");
$language_ext=Array( "c", "cc", "pas", "java", "rb", "sh", "py", "php");
