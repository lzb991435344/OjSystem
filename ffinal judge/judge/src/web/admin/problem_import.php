...
<div class="container">
<h2> Atention:</h2>
<h3>Import FPS data ,please make sure you file is smaller than [<?php echo $maxfile?>] <br/>
or set upload_max_filesize and post_max_size in PHP.ini<br/>
if you fail on import big files[10M+],try enlarge your [memory_limit]  setting in php.ini.<br></h3>
<?php 
    $show_form=true;
...
<form action='problem_import_xml.php' method=post enctype="multipart/form-data">
	<h3>Import Problem:</h3><br />
	<input type=file name=fps >
	<?php require_once("../include/set_post_key.php");?>  <input type=submit value='Import'>
</form>
