...
<html lang="en">
  ...
  <body>
    ...
    <?php include("template/$OJ_TEMPLATE/nav.php");?>	    
      <div class="jumbotron">
                           <h3 style="text-align:center;">Problem <?php echo $id ?> Status</h3> 
<center><table><tr><td>
<table id='statics' >
<?php
$cnt=0;
...
<tr class=toprow><th style="cursor:hand" onclick="sortTable('problemstatus', 0, 'int');"><?php echo $MSG_Number?> </br>
<th>RunID
<th><?php echo $MSG_USER?>
<th ><?php echo $MSG_MEMORY?>
<th ><?php echo $MSG_TIME?>
<th><?php echo $MSG_LANG?> </br>
<th ><?php echo $MSG_CODE_LENGTH?> </br>
